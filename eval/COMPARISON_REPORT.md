...
|---|---|---|---|---|
| ORACLE label t-1 | oracle | 0.997 | 0.996 | 0.33 |
| M3 persistence | unsupervised | 0.961 | 0.784 | 0.47 |
...
| M0 random | control | 0.504 | 0.202 | 0.10 |
| M2 never alert | control | 0.500 | 0.000 | 0.00 |
| M1 always alert | control | 0.500 | 0.000 | 0.00 |
| B3 isolation forest | unsupervised | 0.500 | 0.410 | 0.61 |
| M8 matrix profile | unsupervised | 0.485 | 0.098 | 0.08 |
...
Best baseline ORACLE label t-1 (0.997) vs best tier Tier 1 (0.679): **-0.318**
...
| method | kind | AUC | F1 | alert rate |
|---|---|---|---|---|
| ORACLE label t-1 | oracle | 0.986 | 0.977 | 0.18 |
| B7 logistic regression | supervised | 0.968 | 0.682 | 0.12 |
| B6 CUSUM | unsupervised | 0.958 | 0.000 | 0.00 |
| M3 persistence | unsupervised | 0.851 | 0.503 | 0.21 |
| B8 random forest | supervised | 0.747 | 0.378 | 0.14 |
| M8 matrix profile | unsupervised | 0.596 | 0.227 | 0.12 |
| M0 random | control | 0.526 | 0.165 | 0.10 |
...
Best baseline ORACLE label t-1 (0.986) vs best tier Tier 1 (0.502): **-0.484**
...
| method | kind | AUC | F1 | alert rate |
|---|---|---|---|---|
| ORACLE label t-1 | oracle | 0.996 | 0.993 | 0.20 |
| M3 persistence | unsupervised | 0.973 | 0.811 | 0.29 |
...
| M0 random | control | 0.510 | 0.135 | 0.10 |
...
| M8 matrix profile | unsupervised | 0.459 | 0.065 | 0.09 |
| B6 CUSUM | unsupervised | 0.145 | 0.372 | 0.89 |

Best baseline ORACLE label t-1 (0.996) vs best tier Tier 1 (0.909): **-0.087**
...
- **bab_el_mandeb**: ORACLE label t-1 at 0.997 beats the best tier at 0.679
- **hormuz**: ORACLE label t-1 at 0.986 beats the best tier at 0.502
- **panama**: ORACLE label t-1 at 0.996 beats the best tier at 0.909

### False-positive harness (Malacca)

Malacca has zero labelled disruptions across 2019-2026, so every alert is a false alarm. Mean alert rate: **tiers 23%**, **baselines 7%**. The multi-agent tiers are the noisier of the two.
