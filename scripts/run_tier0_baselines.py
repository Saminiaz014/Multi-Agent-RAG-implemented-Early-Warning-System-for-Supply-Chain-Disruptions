"""Run Tier 0 control baselines on the Hormuz 4x5 benchmark grid.

Run from project root::

    python scripts/run_tier0_baselines.py
"""
...
def run_tier0_baselines() -> None:
    """Run all Tier 0 baselines on every Hormuz 4x5 scenario parquet."""
    ...
    logger.info("=" * 60)
    logger.info("Wrote %d result files to %s", total, _RESULTS_DIR)
    logger.info("=" * 60)
